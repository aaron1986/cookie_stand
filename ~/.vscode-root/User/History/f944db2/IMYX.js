...
const shopLocationTDubai = new ShopLocation("Dubai",11,38,3.7);

const shopLocationTParis = new ShopLocation("Paris",20,38,2.3);

const shopLocationTLima = new ShopLocation("Lima",2,16,4,6);
